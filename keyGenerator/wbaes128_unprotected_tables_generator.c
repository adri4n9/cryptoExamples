...
int main(int argc, char *argv[])
{
    ...
    unsigned char key[16] = "DEFCON32MADEEASY";
    unsigned char plain_block[16] = "whatdup folks???";
    unsigned char round_keys[11][16] = { 0 };
    
    if( argc == 2 ) {

		//assuming the input is always 16 characters representing the key
		snprintf(key, 17, "%s", argv[1]);
    ...
    printf("const unsigned char Txor[0x10][0x10] =\n{\n");
